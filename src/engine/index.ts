...
// NOTE: OpSemRegistry uses import.meta.url for YAML loading — cannot be
// re-exported through this barrel (Jest CJS compat). Import directly:
//   import { OpSemRegistry } from '@rulsynor/core'; // (root index re-exports from op-sem-registry.js)
