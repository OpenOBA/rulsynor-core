...
export type { RuleDefinition, RuleMatch, EvaluationResult, RuleCondition, Decision, OverrideLevel, RingLevel, RuleAction } from './engine/index.js';
...
export {
  ...
  OPERATOR_ALIASES, OP_COMPILE_DIRECT, OP_COMPILE_VIA_NOT, OP_COMPILE_VIA_LENGTH_COUNT,
  isConditionOperator, normalizeOperatorName,
  DO_DECISIONS, WORKFLOW_SUBSTATES, INTERNAL_REASONING, INTERNAL_STATES, RULSYNOR_EXTENSIONS,
  ALL_DECISIONS, GUARD_ALLOWED_DECISIONS, BLOCKING_DECISIONS, isDODecision, isDecision,
  RULE_CATEGORIES, RULE_NAME_PREFIXES, OCCUPATION_CATEGORIES,
  SEMANTIC_NODES, SEMANTIC_NODE_NAMES, EXPR_NODE_TYPES, SCHEMA_COUNTS, SPEC_BASELINE,
} from './engine/erdl-schema.js';
export type {
  ConditionOperator, ConditionModifier, AnyOperator, OperatorValueShape,
  DODecision, RuleCategory, OccupationCategory,
} from './engine/erdl-schema.js';
